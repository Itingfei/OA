...
(/** @lends <global> */function( $ ) {
		...
		for ( i=0, ien=settings.aoData.length ; i<ien ; i++ ) {
			...
			if ( ! row._aFilterData ) {
				...
				for ( j=0, jen=columns.length ; j<jen ; j++ ) {
					...
					// If it looks like there is an HTML pojo in the string,
	...
	DataTable = function( options )
	{
		...
		/**
		 * Provide a templates.common method for plug-ins to check the version of DataTables being used, in order
	...
	/**
	 * Provide a templates.common method for plug-ins to check the version of DataTables being
