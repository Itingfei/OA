$(function () {
    ...
    opentabs = function (href,index,text,boolean) {
        var o = href, m = index, l = text, k = boolean;
        if (o == undefined || $.trim(o).length == 0) {
            return false
        }
...
// 关闭tab页
    closetabs = function (url,width) {
        var m = url;
        var l = width;
        parent.$(".J_menuTab").each(function (k) {
            if ($(this).data("id") == url) {
                if ($(this).parents(".J_menuTab").hasClass("active")) {
                    if ($(this).parents(".J_menuTab").next(".J_menuTab").size()) {
                        var k = $(this).parents(".J_menuTab").next(".J_menuTab:eq(0)").data("id");
    ...
    $(".J_tabCloseAll").on("click", jcloseall = function () {
