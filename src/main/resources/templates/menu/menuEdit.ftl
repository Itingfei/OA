            ...
            <div class="ibox float-e-margins">
               <#-- <div class="ibox-title">
                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal" id="commentForm" action="<#if menu.id??>/menu/${menu.id}/update<#elseif parent.id??>${request.contextPath}/menu/${parent.id}/appendChild<#else>${request.contextPath}/menu/0/appendChild</#if>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="input-group">
                                    <input type="text" id="parentMenuName" name="parentMenuName" class="form-control" value="${parent.name}" readonly />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="name"  placeholder="请填写菜单名称" name="name" maxlength="30" value="<#if menu.name??>${menu.name}</#if>" >
								<span class="help-block m-b-none">用于菜单前台显示</span>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">菜单类型:<font color="red">*</font></label>
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <select data-placeholder="选择菜单类型..." class="chosen-select" style="width:665px;" tabindex="2" name="type" id="type">
                                        <option value="0" <#if menu?? && menu.type?? && menu.type == 0>selected="selected"</#if>>后台系统</option>
                                        <option value="1" <#if menu?? && menu.type?? && menu.type == 1>selected="selected"</#if>>APP</option>
                                    </select>
                                </div>
                                <span class="help-block m-b-none">用于菜单前台显示</span>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" placeholder="请添加菜单链接" class="form-control" name="href" id="href" maxlength="50" value="<#if menu.href??>${menu.href}</#if>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control digits" placeholder="请填写排序顺序" name="sort"  maxlength="4" value="${menu.sort?default('1')}" />
                            ...
                            <div class="col-sm-10">
								<div class="row">
                                    <div class="radio i-checks" style="float: left">
                                        <label class="">
										<div style="position: relative;" class="iradio_square-green"><input style="position: absolute; opacity: 0;"  value="1" <#if menu.isShow?? && menu.isShow==1>checked="checked"</#if> id="isShow" name="isShow" type="radio"><ins style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;" class="iCheck-helper"></ins></div> <i></i>显示</label>
                                    </div>
									<div class="radio i-checks"  style="float: left">
										<label class="">
										<div style="position: relative;" class="iradio_square-green"><input style="position: absolute; opacity: 0;"  value="0" <#if menu.isShow?? && menu.isShow==0>checked="checked"<#elseif !menu.isShow?? >checked="checked"</#if> name="isShow" type="radio"><ins style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;" class="iCheck-helper"></ins></div> <i></i> 隐藏</label>
									</div>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="请填写权限标识" name="permission" maxlength="50" value="<#if menu.permission??>${menu.permission}</#if>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control text-area" placeholder="请填写备注" name="remarks"><#if menu.remarks??>${menu.remarks}</#if></textarea>
                            </div>
                        </div>
                    </form>
