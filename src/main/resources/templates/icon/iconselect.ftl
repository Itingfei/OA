<!DOCTYPE html>
<html>
<!-- Mirrored from www.zi-han.net/theme/hplus/fontawesome.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Jan 2016 14:19:52 GMT -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>OA系统- 字体图标</title>
   <#include "/include.ftl"/>
</head>
<body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <#--<div class="ibox-title">-->
                        <#--&lt;#&ndash;<h5>系统图标</h5>&ndash;&gt;-->
                        <#--<div class="ibox-tools">-->
                            <#--<a class="collapse-link">-->
                                <#--<i class="fa fa-chevron-up"></i>-->
                            <#--</a>-->
                            <#--&lt;#&ndash;<a class="dropdown-toggle" data-toggle="dropdown" href="icons.html#">&ndash;&gt;-->
                                <#--&lt;#&ndash;<i class="fa fa-wrench"></i>&ndash;&gt;-->
                            <#--&lt;#&ndash;</a>&ndash;&gt;-->
                            <#--&lt;#&ndash;<ul class="dropdown-menu dropdown-user">&ndash;&gt;-->
                                <#--&lt;#&ndash;<li><a href="icons.html#">选项1</a>&ndash;&gt;-->
                                <#--&lt;#&ndash;</li>&ndash;&gt;-->
                                <#--&lt;#&ndash;<li><a href="icons.html#">选项2</a>&ndash;&gt;-->
                                <#--&lt;#&ndash;</li>&ndash;&gt;-->
                            <#--&lt;#&ndash;</ul>&ndash;&gt;-->
                    ...
                    <div class="ibox-content icons-box">
                        <section id="new">
                            <h2 class="page-header">系统新增的66个图标</h2>
            ...
            <div class="form-group">
                <div class="col-xs-2">
                    <button type="button" class="btn btn-white" id="close_dis">取消</button>
                </div>
    ...
    <script type="text/javascript">
        $(function(){
            $("a").click(function(){
                ...
                $("a").removeClass("icon-white");
                $(this).addClass("active");
                var icon = $(this).text();
                var i = $(this).children();
                window.parent.document.getElementById("icon").value = $(i).attr("class");
                window.parent.document.getElementById("iconIconLabel").innerHTML = icon;
                window.parent.document.getElementById("iconIcon").className = $(i).attr("class");
                var index = parent.layer.getFrameIndex(window.name); //先得到当前iframe层的索引
                parent.layer.close(index); //再执行关闭
            });
            // 关闭当前弹窗
            $("#close_dis").on("click",function(){
                closeModal();
//                var index = parent.layer.getFrameIndex(window.name); //先得到当前iframe层的索引
//                parent.layer.close(index); //再执行关闭
            });
...
<!-- Mirrored from www.zi-han.net/theme/hplus/fontawesome.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Jan 2016 14:19:53 GMT -->
</html>
