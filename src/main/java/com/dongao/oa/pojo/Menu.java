...
//    private Integer messageSize;
    ...
    /**
     * 获取是否在菜单中显示(0默认不显示，1显示)
     *
     * @return is_show - 是否在菜单中显示(0默认不显示，1显示)
     */
    ...
    /**
     * 设置是否在菜单中显示(0默认不显示，1显示)
     *
     * @param isShow 是否在菜单中显示(0默认不显示，1显示)
     */
    ...
    /**
     * 获取是否记录日志标记(0默认不记录，1记录)
     *
     * @return log_flag - 是否记录日志标记(0默认不记录，1记录)
     */
    ...
    /**
     * 设置是否记录日志标记(0默认不记录，1记录)
     *
     * @param logFlag 是否记录日志标记(0默认不记录，1记录)
     */
